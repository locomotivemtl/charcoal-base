...
trait AuthorizableTrait
{
     ...
     * @param  string|array|\Charcoal\User\UserPermissionInterface $ability   The permission identifier,
     *     array, or object.
     ...
     * @param  mixed                                         $arguments  Options or model(s) related to
     *     the tested permission.
